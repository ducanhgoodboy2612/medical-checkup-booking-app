                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                ...
                                                <div className="carousel-caption d-flex flex-column justify-content-end">
                                                    ...
                                                    <p>Kết nối với bác sĩ và bệnh viện uy tín trên khắp Việt Nam</p>
                                                </div>
                                            </div>
                                            <div className="carousel-item">
                                                ...
                                                <div className="carousel-caption d-flex flex-column justify-content-end">
                                                    <h1>Non-profit</h1>
                                                    <p>Đặt lịch hoàn toàn MIỄN PHÍ</p>
                                                </div>
                                            </div>
                                            <div className="carousel-item">
                                                <img
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-12">
                                    <div className="custom-text-box">
                                        ...
                                        <h5 className="mb-3">
                                            MediLife Booking, Non-Profit Organization
                                        </h5>
                                        <p className="mb-0">
                                            Sứ mệnh của chúng tôi là kết nối bệnh nhân với các bác sĩ hàng đầu và bệnh viện uy tín trên khắp Việt Nam. 
