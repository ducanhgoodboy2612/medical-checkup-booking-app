...
import { getPaged_Spec, getAllTitle } from '../services/home.service'; // Added getAllTitle
import { getPaged_Doctor } from '../services/home.service'; // Assuming you have a service to fetch doctors
                ...
                {cartItems.map((item) => (
                  <div key={item.doctorId} className="list-group-item">
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        <h6 className='mt-3'>{item.title} {item.doctorName}</h6>
        ...
        <div className="col-md-9">
          ...
          <div className="row g-1" >
            {data.length > 0 ? data.map((x: any, index: number) => (
              // <div className="col-md-12 mb-4" key={x.id}
              //   style={{
              //     margin: '10px auto',
              ...
              <div className="col-md-10 mb-4" key={x.id}
                style={{
                  margin: '10px auto',
                  backgroundColor: index % 2 === 0 ? '#F5F5F5' : '#ffffff',
                  borderRadius: 10
                          ...
                          <div className="col-3" key={schedule.id}>
                            ...
                            {schedule.sumBooking >= schedule.maxBooking ? (
                              ...
                              >
                                ...
                                <button
                                  className="btn btn-outline-success w-100"
                                    onClick={() => addToCart(x, 1, schedule.time)}
                                  style={{ fontSize: 14 }}
                                >
                                  {schedule.time}
                                </button>
...
export default Multi_SpecialtiesBook;
